        ...
        if game_state == "start":
            ...
            if time_passed < 1:
                ...
                if player_choice == pc_choice:
                    result_text, result_color = "TIE!", COLOR_TIE
                    ...
                    result_text, result_color = "YOU WIN!", COLOR_WIN
                    score_player += 1
                else:
                    result_text, result_color = "YOU LOSE!", COLOR_LOSE
                    if player_choice != "Unknown" and player_choice is not None: score_pc += 1
